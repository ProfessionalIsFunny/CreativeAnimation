...
BIInterpolation const BILayerColorInterpolation = ^id (UIColor *from, UIColor *to, CGFloat time, BIEasingCurve easing) {
...
BIInterpolation const BIViewColorInterpolation = ^id (UIColor *from, UIColor *to, CGFloat time, BIEasingCurve easing) {
    CGFloat fromHue = 0.0f;
    CGFloat fromSaturation = 0.0f;
    CGFloat fromBrightness = 0.0f;
    CGFloat fromAlpha = 0.0f;
...
BIInterpolation InterpolationForKeyPath(NSString *path) {
    ...
    dispatch_once(&onceToken, ^{
        dict = @{kBILayerCornerRadius:BINumberInterpolation,
                 ...
                 kBILayerBackgroundColor:BILayerColorInterpolation,
